var loaderService = angular.module('loaderService', [])
    .service('loaderService', function ($rootScope) {
        ...
        this.createLoader = function (msg) {
            ...
            let ani = document.getElementById('wfoLoaderShowbox');
            let txt = document.getElementById('wfoLoaderTextbox');
        ...
        this.removeLoader = function (msg) {
            ...
            $rootScope.LoaderTimeout = setTimeout(function () {
                let loadedHTML = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2" class="ld">\
