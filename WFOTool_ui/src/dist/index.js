...
var WFOTool = angular.module('WFOTool', ['ngRoute', 'navigationComponent', 'planInputs', 'planOutputs', 'compare', 'home', 'testView', 'testComponent', 'messageService', 'restService', 'loaderService', 'conflictService', 'alertService']);
